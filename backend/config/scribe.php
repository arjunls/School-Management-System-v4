...
return [
    ...
    'description' => 'RESTful API for managing schools, students, teachers, classes, grades, attendance, library, and more.',
    ...
    'auth' => [
        ...
        'extra_info' => 'This API uses Laravel Sanctum for authentication. Include your Bearer token in the Authorization header of protected endpoints.',
    ],
