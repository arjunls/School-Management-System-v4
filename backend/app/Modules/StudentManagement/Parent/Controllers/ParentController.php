...
use App\Modules\StudentManagement\Parent\Requests\LinkParentRequest;
use App\Modules\StudentManagement\Parent\Requests\UnlinkParentRequest;
...
class ParentController extends Controller
{
    ...
    public function getStudentGrade(Request $request, int $studentId)
    {
        ...
        $grades = $student->grades ?? \App\Modules\Learning\Grade\Models\Grade::where('student_id', $studentId)->with('subject')->get();
