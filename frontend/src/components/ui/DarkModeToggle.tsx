...
export function DarkModeToggle() {
  ...
  return (
    <button onClick={toggle} className="p-2 rounded-md border border-gray-300 hover:bg-gray-50 text-gray-700 dark:border-gray-600 dark:hover:bg-gray-800 dark:text-gray-300" title={dark ? 'Light mode' : 'Dark mode'}>
      {dark ? (
